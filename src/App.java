...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Set<String> treSet2 = setsClase.construirTreeSetConComparador();
        System.out.println(treSet2);

        Set<Person> treePersons = setsClase.personTreeSet();
    ...
    public static void runMaquina(){
        ...
        Set<Maquina> maquinasOrdenadas = controller.ordenarPorSubred(maquinas);
